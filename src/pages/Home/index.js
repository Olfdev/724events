  ...
  return <>
    ...
    <main>
      ...
      <section className="EventsContainer">
        <h2 className="Title" id="nos-realisations" data-testid="realisations">Nos réalisations</h2>
        <EventList />
      </section>
      <section className="PeoplesContainer">
        <h2 className="Title" id="notre-equipe" data-testid="equipe">Notre équipe</h2>
    ...
    <footer className="row">
      <div className="col presta">
        ...
        {last && last.cover && last.title ? (
          ...
          <p>Dernière prestation non disponible</p>
        )}
      </div>

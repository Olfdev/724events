...
describe("Icon component", () => {
    ...
    describe("When a icon is created with name youtube", () => {
        it("the icon contain this path hash values 43342876c2fc40e5b2afe621443ff95b, 0af3bfe3ff95607efaf2b66ed8df1253", () => {
            render(<Icon name="youtube" />)
            expect(md5(screen.getByTestId("icon").getAttribute('d'))).toEqual('43342876c2fc40e5b2afe621443ff95b')
            expect(md5(screen.getByTestId("icon1").getAttribute('d'))).toEqual('0af3bfe3ff95607efaf2b66ed8df1253')
        });
    });
    describe("When a icon is created with name close", () => {
        it("the icon contain this path hash values fe53fa5bf815b6d5983fcadf9a15d3d1", () => {
